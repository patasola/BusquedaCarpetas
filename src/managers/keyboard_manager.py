...
class KeyboardManager:
    ...
    def configure_all_shortcuts(self):
        ...
        shortcuts = {
            ...
            '<F4>': lambda e: self.app.ui_manager.cambiar_modo_entrada(),  # Cambiar modo numérico/alfanumérico
            '<F5>': lambda e: self.app.ui_manager.enfocar_y_seleccionar_campo(),  # Enfocar búsqueda
